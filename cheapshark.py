...
current_date = end_date = datetime.now()
...
latest = pd.read_csv('games_data.csv', header=0, sep = ',')
...
updated_df.sort_values(by = 'UpdateTime', ascending = False)

# Guardar el DataFrame en un archivo CSV
updated_df.to_csv('games_data.csv', index=False)